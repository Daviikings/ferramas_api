...
var validadorSubCategoria = [check('nombre').exists().withMessage("Favor debe ingresar el nombre de la SubCategoria").notEmpty().withMessage("Favor este campo debe venir con informacion"), check('estado').exists().withMessage("Favor debe ir el atributo estado").notEmpty().withMessage("Favor este campo debe venir con informacion").isInt({
  min: 0,
  max: 1
...
module.exports = {
  validadorSubCategoria: validadorSubCategoria
};