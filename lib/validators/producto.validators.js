...
var validadorProducto = [check('nombre').exists().withMessage("Favor ingresar nombre del Producto").notEmpty().withMessage("Favor este campo no puede venir vacio").isLength({
  min: 3,
  max: 64
  ...
  min: 0
}).withMessage("Favor solo debe ingresar  numero de subcategoria"), function (req, res, next) {
