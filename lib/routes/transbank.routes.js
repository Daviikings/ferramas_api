...
var _require4 = require('../validators/transbank.validators'),
  validadorTransbank = _require4.validadorTransbank;

// Importamos el SDK de Transbank
var WebpayPlus = require("transbank-sdk").WebpayPlus;
var _require5 = require("transbank-sdk"),
  Options = _require5.Options,
  IntegrationApiKeys = _require5.IntegrationApiKeys,
  Environment = _require5.Environment,
  IntegrationCommerceCodes = _require5.IntegrationCommerceCodes,
  TransactionNonInsertedCodes = _require5.TransactionNonInsertedCodes;
// Configura las opciones de Transbank
var tx = new WebpayPlus.Transaction(new Options(IntegrationCommerceCodes.WEBPAY_PLUS, IntegrationApiKeys.WEBPAY, Environment.Integration));
// Instancia de nuestra Router de Express
var router = Router();

// Ruta para iniciar el pago transaction
router.post('/credit', TokenTrue, [validadorTransbank], /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, buyOrder, sessionId, amount, returnUrl, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, buyOrder = _req$body.buyOrder, sessionId = _req$body.sessionId, amount = _req$body.amount, returnUrl = _req$body.returnUrl; // Crea la transacción con los valores recibidos
          _context.next = 4;
        ...
        case 8:
          ...
          httpError(res, "Error al iniciar pago", _context.t0);
        case 12:
        case "end":
...
router.get('/checkPayment', TokenTrue, /*#__PURE__*/function () {
...
router.get('/endPayment', /*#__PURE__*/function () {
