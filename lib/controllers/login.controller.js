...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, correo, password, db, sql, _yield$db$query, _yield$db$query2, row, ASDA, existo, usuario, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          //DESCONTRUIMOS EL OBJETO BODY OBTENIENDO SOLO LOS CAMPOS A USAR
          _req$body = req.body, correo = _req$body.correo, password = _req$body.password; //INSTACIA DE NUESTRA BASE DE DATOS
          _context.next = 4;
          return database();
        case 4:
          db = _context.sent;
          //GENERAMOS QUERY A EJECUTAR
          sql = "SELECT * \n                    FROM usuario \n                    WHERE correo_electronico = '".concat(correo, "'");
          /**
        ...
        case 8:
          ...
          _yield$db$query2 = _slicedToArray(_yield$db$query, 2);
          row = _yield$db$query2[0];
          ASDA = _yield$db$query2[1];
          if (row.length) {
            _context.next = 14;
            break;
          }
        ...
        case 14:
          ...
          existo = desencriptar(password, row[0].password); //VALIDO QUE ESTO SEA VERDADERO
          if (existo) {
            _context.next = 17;
            break;
          }
        ...
        case 17:
          ...
          token = jwt.crearToken(usuario); //RESPONEMOS AL CLIENTE CON EL TOKEN
          res.json({
            "ok": true,
            token: token
          });
        ...
        case 22:
          ...
          return _context.abrupt("return", httpError(res, "Ocurrio algo en Login"));
        case 25:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          return _context2.abrupt("return", httpError(res, "Ocurrio algo en Verificar Token"));
        case 7:
        case "end":
